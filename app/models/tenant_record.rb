class TenantRecord < ActiveRecord::Base
  ...
  conditionally_validate :base_rent,
             :presence => true, :numericality => true, unless: :stepped_rents.present?
  ...
  conditionally_validate :escalation,
            :presence => true, :numericality => { :greater_than_equal_to => 0, :less_than_equal_to => 100 }, :allow_nil => true, unless: :stepped_rents.present?
