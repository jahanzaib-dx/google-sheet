...
Rails.application.routes.draw do
  ...
  get 'back_end_lease_comps/validate_spreadsheet/:temp' => 'back_end_lease_comps#validate_spreadsheet'
  ...
  get 'back_end_sale_comps/validate_spreadsheet/:temp' => 'back_end_sale_comps#validate_spreadsheet'
